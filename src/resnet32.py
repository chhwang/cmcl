    ...
    with tf.variable_scope('inference'):
        ...
        for m in range(FLAGS.num_model):
            ...
            with tf.variable_scope('model_%d' % m):
                ...
                l = residual('res_1_4', l, 16, 16, 1)
                l = residual('res_1_5', l, 16, 16, 1)
                features.append(l)
        ...
        for m in range(FLAGS.num_model):
            ...
            with tf.variable_scope('model_%d' % m):
                ...
                l = residual('res_2_4', l, 32, 32, 1)
                l = residual('res_2_5', l, 32, 32, 1)

                l = residual('res_3_1', l, 32, 64, 2)
                l = residual('res_3_2', l, 64, 64, 1)
                l = residual('res_3_3', l, 64, 64, 1)
                l = residual('res_3_4', l, 64, 64, 1)
                l = residual('res_3_5', l, 64, 64, 1)
